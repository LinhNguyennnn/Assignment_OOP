...
namespace Assignment
{
    public class ConsoleTable
    {
        ...
        public void Write(Format format = Assignment.Format.Default)
        {
            switch (format)
            {
                case Assignment.Format.Default:
                    Console.WriteLine(ToString());
                    break;
                case Assignment.Format.MarkDown:
                    Console.WriteLine(ToMarkDownString());
                    break;
                case Assignment.Format.Alternative:
                    Console.WriteLine(ToStringAlternative());
                    break;
                case Assignment.Format.Minimal:
